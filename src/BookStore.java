...
public class BookStore extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Books", "Pencils", "Pens", "Bags" }));

        jLabel2.setText("Book Type");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "JAVA", "PHP" }));
